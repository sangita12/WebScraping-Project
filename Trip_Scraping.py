...
# dataframe.plot.bar('Places',"Rating",title='Top Places to Visit in Nepal 2021')
# plot.show()



# placeList = dataframe['Places']
# ratingList = dataframe['Rating']

# plot.pie(ratingList,autopct='%1.2f%%')
# plot.title('Top places to Do in Nepal 2021')
# plot.legend(placeList,bbox_to_anchor=(1,1),title='Places')
# plot.show()

# highestRating = dataframe['Rating'].max()
# print("Highest rated places:\n", dataframe.query('Rating == @highestRating'))
# print()

# lowestRating = dataframe['Rating'].min()
# print("Lowest rated places:\n", dataframe.query('Rating == @lowestRating'))
